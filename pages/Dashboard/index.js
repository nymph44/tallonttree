          ...
          <div className="w-1/2 border border-base-300 bg-base-200 rounded-xl pr-2 flex space-x-4">
            <div className='flex-col flex'>
              <div className="border border-base-200 bg-base-300 rounded-xl  w-60 p-4 m-4 ">
                ...
                <div className="flex space-x-4 py-4">
                  <div className="bg-primary rounded-full w-12 h-12 flex justify-center items-center p-2">
                    <svg className=" stroke-base-content " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} >
              ...
              <div className="border border-base-200 bg-base-300 rounded-xl  w-60  p-4 m-4">
                ...
                <div className="flex space-x-4 py-4 ">
                  <div className="bg-primary rounded-full w-12 h-12 flex justify-center items-center p-2">
                  <svg  className=" stroke-base-content " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
